...
function App() {
  return (
    ...
    <div>
      <Navbar/>
      <div className='mx-40'>
        <div className='text-orange-500 mb-3 mt-2 font-bold text-2xl'>Cookies Policy</div>
        <h4 className='font-bold mt-3 mb-2'>Introduction</h4>
        ...
        <div className='font-bold mt-2 mb-2 text-sm mx-9'>
      ...
      <div>
        <table className='border-4  border-x-2 border-y-2 border-solid-800'  >
        <tr className='border border-spacing-4 w-full '>
          <th>Category</th>
          <th>description</th>
          
        </tr>
        <tr className='border border-spacing-4 w-full'>
        <td className='text-xs '>1. Essential Cookies</td><td className='text-xs'>Essential cookies (First Party Cookies) are sometimes called “strictly necessary” as without them we cannot provide many services that you need on the Website. For example, essential cookies help remember your preferences as you move around the Website. Essential cookies also keep you logged in into a website. Without them the login functionality would not work. </td> </tr>
        <tr className='border border-spacing-4 w-full'>
          <td className='text-xs'>2.Analytics Cookies</td><td className='text-xs'>These cookies track information about visits to the 99acres.com and partner websites so that we can make improvements and report our performance. For example: analyse visitor and user behaviour so as to provide more relevant content or suggest certain activities. They collect information about how visitors use the Websites, which site the user came from, the number of each user’s visits and how long a user stays on the Websites. We might also use analytics cookies to test new ads, pages, or features to see how users react to them.
        ...
        <tr className='border border-spacing-4 w-full'>
          <td className='text-xs'>3. Functionality or Preference Cookies</td><td className='text-xs'>
        ...
        <tr className='border border-spacing-4 w-full'>
        <td className='text-xs'>4.Targeting or Advertising Cookies </td><td className='text-xs'>
        ...
        <div>
           <div className='text-blue-500 text-xs'> <a href='https://www.facebook.com/privacy/policy/?entry_point=data_policy_redirect&entry=0'>   https://www.facebook.com/policy.php</a></div>
            
            <div className='text-blue-500 text-xs'> <a href='https://policies.google.com/technologies/ads'>
                https://www.policies.google.com/technologies/ads  </a></div>
            <div className='text-blue-500 text-xs'> <a href='https://marketingplatform.google.com/about/'> http://www.google.com/analytics/learn/privacy.html</a></div>
            <div className='text-blue-500 text-xs'> <a href='https://marketingplatform.google.com/about/'>
                   https://www.google.com/analytics/tag-manager/faq/</a></div>
            <div className='text-blue-500 text-xs'> <a href='https://policies.google.com/privacy'>
                  https://www.google.com/policies/privacy/</a></div
            ><div className='text-blue-500 text-xs'> <a href='https://twitter.com/en/privacy'>
                https://twitter.com/en/privacy </a></div>
            <div className='text-blue-500 text-xs'> <a href='https://support.google.com/admanager/answer/2839090?hl=en'>
                https://support.google.com/dpf_premium/answer/2839090?hl=en </a></div>
            </div>
        ...
        <div className='text-xs mt-2 mb-2'>
        Most browsers allow you to control cookies through their settings preferences. However, if you choose to turn off these cookies, you will still see advertising on the internet but it may not be tailored to your interests. It does not mean that you won't be served any advertisements whilst you are online. Whilst we have mentioned most of the third parties involved in using targeting or advertising cookies in the preceding <span className='text-blue-900 font-extrabold'>section</span>, the list is not exhaustive and is subject to change. Therefore, even if you choose to turn off all the third party cookies listed in <span  className='text-blue-900 font-extrabold'>section</span> , you may still receive some tailored advertisements and recommendations.
        </div>
       <div className='text-xs mt-2 mb-2'>
      ...
      <div>
        <i className='text-sm font-bold'>Changing your Cookies Settings</i><div className='text-xs mt-2 mb-2'>
        ...
        <div className='text-blue-900 text-xs mt-2 mb-2'>
          <div className='mt-2 mb-2 ml-7'>
          <a href='https://support.microsoft.com/en-us/windows/delete-and-manage-cookies-168dab11-0753-043d-7c16-ede5947fc64d'>.Cookie settings in Internet Explorer </a>
          </div>
          <div className='mt-2 mb-2 ml-7'>
          <a href='https://support.mozilla.org/en-US/kb/enhanced-tracking-protection-firefox-desktop?redirectslug=enable-and-disable-cookies-website-preferences&redirectlocale=en-US'>.Cookies settings in Firefox </a>
          </div>
          <div className='mt-2 mb-2 ml-7'>
          <a href='https://support.google.com/chrome/answer/95647'>.Cookies settings in Chrome</a>
          </div>
          <div className='mt-2 mb-2 ml-7'>
          <a href='https://support.apple.com/kb/ph21411?locale=en_GB'>.Cookies settings in Safari</a>
          </div>
          <div>
